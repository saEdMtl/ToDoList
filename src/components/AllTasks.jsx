...
function AllTasks({ t, index, doneTask, deleteHandler, moveDown, moveUp, edit, clickHandler }) {
                ...
                editTask
                    ...
                    : (<div className='animate__animated animate__lightSpeedInLeft'>
                        <div className="border-1 md:p-4 p-2 rounded-xl mt-2">
                            ...
                            <h6 style={{ textDecoration: `${t.status ? "line-through" : ""}` }} className='sm:mb-3 mb-1 sm:text-lg text-sm font-bold'>{t.name}</h6>
                            {
                                t.status ?
                            ...
                            {!t.status && <button onClick={() => doneTask(index)} className={`${classNames.buttons}`}>Done!!</button>}
